...
// Kafka implements transport interface for kafka protocol
type Kafka struct {
...
func (k *Kafka) Init(url string, token string) error {
...
func (k *Kafka) Transmit(topic string, data []byte) error {
